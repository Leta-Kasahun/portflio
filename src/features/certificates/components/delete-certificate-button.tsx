...
import { deleteCertificateAction } from "../mutations";
...
export function DeleteCertificateButton({
  ...
  const handleDelete = () => {
    if (confirm(`Are you sure you want to delete certificate "${certificateName}"?`)) {
      startTransition(async () => {
        await deleteCertificateAction(certificateId);
      });
    }
  };
